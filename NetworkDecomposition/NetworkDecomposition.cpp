...
int Graph::networkdecomposition()
{
	...
	std::vector<node_id> active_nodes;
	std::vector<node_id> stalled_nodes;//to send update to neighbors at the end of a step
	std::vector<node_id> finished_nodes;
	std::vector<node_id> accepted_nodes;//to send update to neighbors at the end of a step
	std::vector<node_id> killed_nodes;
	std::vector<node_id> living_nodes;
